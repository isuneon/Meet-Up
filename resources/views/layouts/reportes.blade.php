...
@media screen and (max-width:600px){.w3-topnav a{display:block}.w3-navbar li:not(.w3-opennav){float:none;width:100%!important}.w3-navbar li.w3-right{float:none!important;padding-bottom:20px;}}    
...
.w3-border-pale-yellow,.w3-hover-border-pale-yellow:hover{border-color:#ffffcc!important}.w3-border-pale-blue,.w3-hover-border-pale-blue:hover{border-color:#e7ffff!important}
 ...
 <body data-ma-theme="green">
    ...
    <footer>
        ...
        <script src="{{ asset('js/chart-tooltips.js') }}"></script>
        <script src="{{ asset('js/other-charts.js') }}"></script>
