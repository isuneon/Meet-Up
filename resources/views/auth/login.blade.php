...
@section('content')
  <head>
    ...
    <title>Materialize Material Design HTML App Landing Template</title>
    ...
    <link href="css/shortcodesae52.css?v=5" rel="stylesheet">

    <link href="css/styleae52.css" rel="stylesheet">
...
<body id="top" data-spy="scroll" data-target="#materialize-menu" data-offset="100">
      ...
      <div class="container">
      <span class="copy-text">Copyright &copy; 2016 <a href="#">Isuneon</a> &nbsp; | &nbsp; All Rights Reserved &nbsp; | &nbsp; Designed By <a href="#">Isuneon</a></span>
      </div>
      </div>
      </footer>
